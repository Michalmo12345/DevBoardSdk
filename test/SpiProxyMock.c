...
static void mock_spi_configure(void *self, void *spi_handle, void *csPort,
                               uint16_t csPin)
{
...
static void mock_spi_transmit_receive(void *self, uint8_t *txData,
...
static void mock_spi_set_cs(void *self, uint16_t state) { mock_csPin = state; }
